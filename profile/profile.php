  ...
  <main>
    ...
    <script>// Assuming you have some code to handle the click event on the Follow button
        function sendAjaxRequest(userIdToFollow, currentUserId) {
            ...
            var url = 'create_follower_relationship.php';
            var params = 'userIdToFollow=' + userIdToFollow + '&currentUserId=' + currentUserId;
        ...
        function sendUnAjaxRequest(userIdToFollow, currentUserId) {
            // Create a new XMLHttpRequest object
            var xhr = new XMLHttpRequest();
        ...
        unfollowButton.addEventListener('click', function() {
            ...
            var userIdToFollow = unfollowButton.getAttribute('data-user-id-to-follow');
            var currentUserId = unfollowButton.getAttribute('data-current-user-id');

            // Call the function to send the AJAX request with the obtained data
            sendUnAjaxRequest(userIdToFollow, currentUserId);
        });
        ...
        followButton.addEventListener('click', function() {
            // Get the data attributes from the button
            var userIdToFollow = followButton.getAttribute('data-user-id-to-follow');
            var currentUserId = followButton.getAttribute('data-current-user-id');
