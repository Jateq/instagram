...
include "../connect.php"; // Assuming you include your database connection here
...
<nav class="navbar">
    ...
    <div>
        ...
        <a href="../direct/direct.html">
            <svg aria-label="Messenger" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
        ...
        <a href="#">
            <svg aria-label="Notifications" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)"
                 height="24" role="img" viewBox="0 0 24 24" width="24"><title>Notifications</title>
                <path  color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" d="M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z"></path>
            </svg>
        </a>


        <a href="../main_page/upload.php">
            <svg aria-label="New post" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
                 role="img" viewBox="0 0 24 24" width="24"><title>New post</title>
        ...
        <a class="threads" href="https://www.threads.net/login">
            <svg aria-label="" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img"
                 viewBox="0 0 192 192" width="24"><title></title>
                <path class="xcslo1z" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)"
    ...
    <a class="a-lasts" href="../settings/settings-main.php">
        <svg aria-label="Settings" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24"
             role="img" viewBox="0 0 24 24" width="24"><title>Settings</title>
            <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<div class="page">
        ...
        <div class="profile-wrap mb-2rem">
            <div class="profile-avatar">
                ...
                <img src="../images/users/<?php echo $userImage?>" alt="<?php echo $userName?>" class="user">
            </div>
            <div class="profile-info">
                ...
                <ul class="profile-numbers mb-1rem">
                    <li>
                        <a href="#">
                            <span class="profile-posts"><?php echo $postsCount?></span>
                            posts
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span class="profile-followers"><?php echo $userFollowers?></span>
                            followers
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span class="profile-following"><?php echo $userFollowing?></span>
                            following
                        </a>
                    </li>
                </ul>
        ...
        <div class="gallery-pics inner-wrap">
            <div class="pic-wrap">
                ...
                function getCommentCount($postId, $conn) {
                    $query = "SELECT COUNT(*) as commentCount FROM comments WHERE post_id = $postId";
                ...
                foreach ($reversedPosts as $post) :
                    ...
                    $postId = $post['id'];
                    ?>
                <a href="../main_page/post_page.php?post_id=<?php echo $postId?>">
                    <div class="pic">
                        <div class="opacity-overlay">
                            <img src="../main_page/uploads/<?php echo $post['image_url']; ?>">
                        </div>
                        <div class="icons">
                            <i class="fa fa-heart"></i><p style="padding-right: 4px;"><?php echo $post['likes']; ?> </p>
                            ...
                            <i class="fa fa-comment"></i><p style="padding-right: 4px;"><?php echo getCommentCount($postId, $conn) ?></p>
                            <svg aria-label="Comment" class="x1lliihq x1n2onr6" color="rgb(255,255,255)" fill="rgb(255,255,255)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Comment</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
