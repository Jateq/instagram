...
<main>
    ...
    <div class="no-saved-materials">
        ...
        <p style="margin-top: 20px; margin-bottom: 0; font-size: 20px; font-weight: bold;">Tagged photos</p>
        <p style="margin-top: 20px; margin-bottom: 0; font-size: 15px;">When people tag in photos, they'll appear here.</p>
      </div>
