...
<div >
    ...
    <div class="post-page-container">
        ...
        <div class="post-page-info">
            ...
            <div style="margin-left: 10px; margin-bottom: 5px" class="post-under-left">
                <a><?php $checkLikedQuery = "SELECT * FROM post_likes WHERE user = '$currenUser' AND post_id = $postId";
            ...
            <div style="margin-left: 16px; margin-bottom: 5px"><?php echo $postLikes?> likes</div>
