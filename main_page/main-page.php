...
<main>
    <div class="scroll">
        <div class="stories">
            <div class="story">
                <a href="../stories/first-story.html">
                    <img src="../images/miras.png">
                    <p>_mrssrkv</p>
                </a>
            </div>

            <div class="story">
                <a href="../stories/second-story.html">
                    <img src="../images/story2.png">
                    <p>_samlage</p>
                </a>
            </div>
            <div class="story">
                <a href="../stories/third-story.html">
            ...
            <div class="story">
                <a href="../stories/forth-story.html">
            ...
            <div class="story">
                <a href="../stories/fifth-story.html">
                    <img src="../images/story5.png">
                    <p>gdsc.kbtu</p>
                </a>
            </div>

            <div class="story-bota">
                <a href="../stories/sixth-story.html">
                    <img src="../images/story6.png">
                    <p>b.bota7</p>
                </a>
            </div>

            <div class="story-bahr">
                <a href="../stories/seventh-story.html">
                    <img src="../images/story7.png">
                    <p>zurgamba...</p>
                </a>
            </div>
        </div>
...
// Check if the current user has liked the post
                        $checkLikedQuery = "SELECT * FROM post_likes WHERE user = '$currentUser' AND post_id = $postId";
                        $checkLikedResult = $conn->query($checkLikedQuery);

// Determine whether the current user has liked the post
                        $userLiked = $checkLikedResult->num_rows > 0;
                        ?>
                        ...
                        <div class="post-container">
                            ...
                            <img src="uploads/<?php echo $post['image_url']; ?>" alt="post">

                            <div class="post-under">
                                <div class="post-under-left">
                                    <a>
                                    ...
                                    <a><svg aria-label="Comment" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Comment</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                                ...
                                <div>
                                    <a><svg aria-label="Save" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Save</title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg></a>
                                </div>
                                ...
                                <div class="post-under-info">
                                    <p class="post-under-info-user-like" id="likesCount_<?php echo $post['id']; ?>">
                                        <?php echo $post['likes']; ?> likes
                                    </p>
                                    <div>
                                        <p class="post-under-info-user-like"><?php echo $post['user']; ?></p>
                                        <p class="post-under-info-text"><?php echo $post['description']; ?></p>
                                    </div>
                                        <?php
                                        $commentsCountQuery = "SELECT COUNT(*) as commentCount FROM comments WHERE post_id = $postId";
                                        $commentsCountResult = mysqli_query($conn, $commentsCountQuery);

                                        if ($commentsCountResult) {
                                            $commentsCount = mysqli_fetch_assoc($commentsCountResult)['commentCount'];
                                            ?>
                                                <?php  if ($commentsCount > 0) { ?>
                                    <div id="commentsContainer">

                                                <a href="post_page.php?post_id=<?php echo $postId ?>">View <?php echo $commentsCount ?> comments </a>
                                    </div>
            ...
            <div class="post-top">
                ...
                <img src="../images/main-post0.png">

                <div class="post-under">
                    <div class="post-under-left">
                        <a><svg aria-label="Unlike" class="like" color="rgb(255, 48, 64)" fill="rgb(255, 48, 64)" height="24" role="img" viewBox="0 0 48 48" width="24"><title>Unlike</title><path d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path></svg></a>
                        <a><svg aria-label="Comment" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Comment</title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                        <a><svg aria-label="Share Post" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Share Post</title><line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon></svg></a>
                    </div>
                ...
                <div class="post-under-info">
                    <p class="post-under-info-user-like">171 likes</p>
                    <div>
                        <p class="post-under-info-user-like">darlene__m</p>
                        <p class="post-under-info-text">Осень имееть особое место в моем сердце💛</p>
                    </div>
                    <div>
                        <label>
            ...
            <div class="post-container">
                <div class="post-top">
                    <div>
                        <img src="../images/main-post2-circle.png" alt="circle">
                        <div class="post-top-info">
                            <p>rrissiw_</p>
                            <p> <span class="x1lliihq x1plvlek xryxfnj x1n2onr6 x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs x1s928wv xhkezso x1gmr53x x1cpjm7i x1fgarty x1943h6x x1i0vuye xvs91rp xo1l8bm x1roi4f4 x10wh9bi x1wdrske x8viiok x18hxmgj" dir="auto" style="line-height: var(--base-line-clamp-line-height); --base-line-clamp-line-height: 18px;">• 10h</span></p>
                ...
                <div class="post-under-info">
                    <p class="post-under-info-user-like">127 likes</p>
                    <div>
                        <p class="post-under-info-user-like">rrissiw_</p>
                        <p class="post-under-info-text">🍂</p>
                    </div>
                    <div>
                        <label>
                            <input type="text" placeholder="Add a comment...">
            ...
            <div class="post-container">
                <div class="post-top">
                    <div>
                        <img src="../images/main-post3-circle.png" alt="circle">
                        <div class="post-top-info">
                            <p>aliyaa__b</p>
                            <p> <span class="x1lliihq x1plvlek xryxfnj x1n2onr6 x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs x1s928wv xhkezso x1gmr53x x1cpjm7i x1fgarty x1943h6x x1i0vuye xvs91rp xo1l8bm x1roi4f4 x10wh9bi x1wdrske x8viiok x18hxmgj" dir="auto" style="line-height: var(--base-line-clamp-line-height); --base-line-clamp-line-height: 18px;">• 1d</span></p>
                ...
                <div class="post-under-info">
                    <p class="post-under-info-user-like">336 likes</p>
                    <div>
                        <p class="post-under-info-user-like">aliyaa__b</p>
                        <p class="post-under-info-text">твое место здесь, на первом ряду 🌸</p>
                    </div>
                    <div>
                        <label>
                            <input type="text" placeholder="Add a comment...">
            ...
            <div class="post-container">
                <div class="post-top">
                    <div>
                        <img src="../images/main-post1-circle.png" alt="circle">
                        <div class="post-top-info">
                            <p>shyndali_u</p>
                            <p> <span class="x1lliihq x1plvlek xryxfnj x1n2onr6 x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs x1s928wv xhkezso x1gmr53x x1cpjm7i x1fgarty x1943h6x x1i0vuye xvs91rp xo1l8bm x1roi4f4 x10wh9bi x1wdrske x8viiok x18hxmgj" dir="auto" style="line-height: var(--base-line-clamp-line-height); --base-line-clamp-line-height: 18px;">• 1d</span></p>
                ...
                <div class="post-under-info">
                    <p class="post-under-info-user-like">183 likes</p>
                    <div>
                        <p class="post-under-info-user-like">shyndali_u</p>
                        <p class="post-under-info-text">келесі постты тағы 1 жыл күтесіздер енді💅</p>
                    </div>
                    <div>
                        <label>
                            <input type="text" placeholder="Add a comment...">
            ...
            <div class="post-container">
                <div class="post-top">
                    <div>
                        <img src="../images/main-post4-circle.png" alt="circle">
                        <div class="post-top-info">
                            <p>gubayevv</p>
                            <p> <span class="x1lliihq x1plvlek xryxfnj x1n2onr6 x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs x1s928wv xhkezso x1gmr53x x1cpjm7i x1fgarty x1943h6x x1i0vuye xvs91rp xo1l8bm x1roi4f4 x10wh9bi x1wdrske x8viiok x18hxmgj" dir="auto" style="line-height: var(--base-line-clamp-line-height); --base-line-clamp-line-height: 18px;">• 2d</span></p>
                ...
                <div class="post-under-info">
                    <p class="post-under-info-user-like">204 likes</p>
                    <div>
                        <p class="post-under-info-user-like">gubayevv</p>
                        <p class="post-under-info-text">20</p>
                    </div>
                    <div>
                        <label>
                            <input type="text" placeholder="Add a comment...">
    ...
    <div class="info-right">
        ...
        <a class="info-right-foot-meta">© 2023 INSTAGRAM FROM META</a>
