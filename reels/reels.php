...
<div style="width: 100%; height: auto; margin: 32px 0 0 65px ; display: flex;">
    <div class="reels">
        <div class="reel">
            <div class="vid">
                <video width="100%" height="100%" controls> <source src="1.MP4" type="video/mp4"> </video>
            </div>
            <div class="mini-navbar">
                <div class="elem"><img style="width: 30px; border-radius: 2px; border: 2px solid; border-color: #262626" src="prof.jpg"></div>
                <div class="elem"><img src="More.png" width="30px" style="margin-bottom: 20px"></div>
                <div class="elem"><img src="Bookmark.png" width="30px" style="margin-bottom: 28px"></div>
                <div class="elem"><img src="Share.png" width="30px" style="margin-bottom: 28px" ></div>
                <div style="font-family: Helvetica, Arial, sans-serif; text-align: center; margin: 5px 0 20px; width: 100%">1M</div>
                <div class="elem"><img src="Comment.png" width="30px"></div>
                <div style="font-family: Helvetica, Arial, sans-serif; text-align: center; margin: 5px 0 20px">175k</div>
                <div class="elem"><img src="Like.png" width="30px"></div>
            </div>
        </div>
        <div class="reel">
            <div class="vid">
                <video width="100%" height="100%" controls> <source src="2.MP4" type="video/mp4"> </video>
            </div>
            <div class="mini-navbar">
                <div class="elem"><img style="width: 30px; border-radius: 2px; border: 2px solid; border-color: #262626" src="prof.jpg"></div>
                <div class="elem"><img src="More.png" width="30px" style="margin-bottom: 20px"></div>
                <div class="elem"><img src="Bookmark.png" width="30px" style="margin-bottom: 28px"></div>
                <div class="elem"><img src="Share.png" width="30px" style="margin-bottom: 28px" ></div>
                <div style="font-family: Helvetica, Arial, sans-serif; text-align: center; margin: 5px 0 20px; width: 100%">988k</div>
                <div class="elem"><img src="Comment.png" width="30px"></div>
                <div style="font-family: Helvetica, Arial, sans-serif; text-align: center; margin: 5px 0 20px">80k</div>
                <div class="elem"><img src="Like.png" width="30px"></div>
            </div>
        </div>
    </div>
